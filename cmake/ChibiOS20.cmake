...
INCLUDE(ChibiOS20_LD)
INCLUDE(ChibiOS20_HAL)
INCLUDE(ChibiOS20_Community)


IF(${CHIBIOS_KERNEL} STREQUAL rt)
  INCLUDE(ChibiOS20_RT)
ELSE()
  INCLUDE(ChibiOS20_NIL)
ENDIF()

INCLUDE(ChibiOS20_Various)
...
FOREACH(comp ${ChibiOS_FIND_COMPONENTS})
    ...
    FOREACH(source ${CHIBIOS_${comp}_SOURCES})
        ...
        message( STATUS "======= BREAKPOINT CMAKE =========== HERE HERE HERE ==========================" )
        message( STATUS "${CHIBIOS_${comp}_${source}}" )
    ENDFOREACH()
